...
function fetchEpisodeDetails(seriesId, seasonNumber, episodeNumber) {
  ...
  fetch(episodeDetailsUrl)
    ...
    .then(details => {
      displayEpisodeDetails(details, seriesId, seasonNumber, episodeNumber);
    })
    .catch(error => {
...
function displayEpisodeDetails(details, seriesId, seasonNumber, episodeNumber) {
  ...
  watchNowButton.addEventListener('click', () => openVideo(seriesId, seasonNumber, episodeNumber));
}

function openVideo(seriesId, seasonNumber, episodeNumber) {
